                    ...
                    if (i < datasetProductDisplay.Tables[0].Rows.Count - 1)
                    {
                        ...
                        divMainDisplay.InnerHtml += "<div class ='productcell' style = 'float:left;'>" +
                            ...
                            "<div  >" +
                                ...
                                "Khuyến mai " + String.Format("{0:#,##0.000;(£#,##0.000);Nothing}", dataRow[datasetProductDisplay.Tables[0].Columns[9]], " ") + " VND  <br> Giá bán " + String.Format("{0:#,##0.000;(£#,##0.000);Nothing}", dataRow[datasetProductDisplay.Tables[0].Columns[7]], " ") + " VND </br>" +
